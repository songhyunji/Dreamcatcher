...
public class SettingCenterText : MonoBehaviour
{
    ...
    string mapnum;
    public bool FirstEnter; // 첫번째 진입인가?
    public bool center; // 센터 타이틀인가?
    ...
    void Update()
    {
        ...
        if (center) // 센터 타이틀일 경우 최초 한 번만 나오기
        {
            if (!FirstEnter)
                alpha = 0;
        }
